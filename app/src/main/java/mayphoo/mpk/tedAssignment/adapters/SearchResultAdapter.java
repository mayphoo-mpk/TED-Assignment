...
public class SearchResultAdapter extends BaseRecyclerAdapter<TalkViewHolder, TalkVO> {

    private TalkDelegate mTalkDelegate;

    public SearchResultAdapter(Context context, TalkDelegate talkDelegate) {
        super(context);
    ...
    public TalkViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View talkView = mLayoutInflater.inflate(R.layout.view_item_search_result, parent, false);
