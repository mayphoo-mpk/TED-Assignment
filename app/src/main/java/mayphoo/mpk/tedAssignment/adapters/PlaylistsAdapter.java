...
public class PlaylistsAdapter extends BaseRecyclerAdapter<TalkViewHolder, TalkVO> {

    private TalkDelegate mTalkDelegate;

    public PlaylistsAdapter(Context context, TalkDelegate talkDelegate) {
        super(context);
    ...
    public TalkViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View talkView = mLayoutInflater.inflate(R.layout.view_item_playlist, parent, false);
