...
public class TalksAdapter extends BaseRecyclerAdapter<TalkViewHolder, TalkVO> {

    private TalkDelegate mTalkDelegate;

    public TalksAdapter(Context context, TalkDelegate talkDelegate) {
        super(context);
    ...
    public TalkViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View talkView = mLayoutInflater.inflate(R.layout.view_item_talks, parent, false);
