...
public class PodcastsAdapter extends BaseRecyclerAdapter<TalkViewHolder, TalkVO> {

    private TalkDelegate mTalkDelegate;

    public PodcastsAdapter(Context context, TalkDelegate talkDelegate) {
        super(context);
    ...
    public TalkViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View talkView = mLayoutInflater.inflate(R.layout.view_item_podcast, parent, false);
